...
<ComponentHtmlMarkup>
  <Form onSubmit={onSubmit} noValidate>
    <FormGroup
      ...
      helperText="Fill fields with your name and surname"
    >
      <FieldGroup inline>
        <InputField
          value=""
    ...
    <FormGroup labelText="Gender" helperText={"Choose your gender"}>
      <FieldGroup inline>
        <RadioButton checked value="male" name="gender" id="gender-radio">
          Male
        </RadioButton>
        <RadioButton value="female" name="gender" id="gender-radio">
          Female
        </RadioButton>
      </FieldGroup>
    </FormGroup>
