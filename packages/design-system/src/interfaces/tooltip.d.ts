...
/**
 * @deprecated 0.3.0, use PopperTooltip instead; will stop working in '@livechat/design-system 0.7.0'
...
/**
 * @deprecated 0.3.0, use CssTooltip instead; will stop working in '@livechat/design-system 0.7.0'
