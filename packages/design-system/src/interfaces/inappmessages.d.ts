...
export interface IInAppMessageBaseProps
...
export interface IInAppMessageHeaderProps
  extends React.HTMLAttributes<HTMLDivElement> {
...
export interface IInAppMessageFooterProps
  extends React.HTMLAttributes<HTMLDivElement> {
  buttons: {
    cta: IButtonProps;
    remind?: IButtonProps;
...
export interface IInAppMessageAvatar
  extends React.DetailedHTMLProps<
      React.ImgHTMLAttributes<HTMLImageElement>,
      HTMLImageElement
    > {}

export interface IInAppMessageImage
  extends React.DetailedHTMLProps<
      React.ImgHTMLAttributes<HTMLImageElement>,
      HTMLImageElement
    > {}
