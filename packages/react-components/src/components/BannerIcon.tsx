...
export const BannerIcon = props => {
    ...
    switch(type) {
        case 'info':
            return <InformationOutlineIcon fill="#4384f5" width="20px" height="20px" className={baseClass} />;
        case 'warning':
            return <AlertIcon fill="#fb9d01" width="20px" height="20px" className={baseClass}/>;
        case 'success':
            return <CheckCircleIcon fill="#38c776" width="20px" height="20px" className={baseClass}/>;
        case 'error':
            return <BlockHelperIcon fill="#d64646" width="20px" height="20px" className={baseClass}/>;            
    }
}
