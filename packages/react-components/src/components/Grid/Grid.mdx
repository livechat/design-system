...
[Intro](#Intro) | [Usage](#Usage) | [Grid Size Controller](#GridSizeController) | [Breakpoints](#Breakpoints) | [Gutters](#Gutters) | [Margins](#Margins) | [Alignment](#Alignment) | [Column System](#ColumnSystem) | [Component API](#ComponentAPI)
...
## Grid Size Controller <a id="GridSizeController" />

The `GridSizeController` is a required wrapper component for the Grid components used as main layout. It enforces maximum width constraints for Grid layouts according to design specifications.

```tsx
import { Grid, Column, GridSizeController } from '@livechat/design-system-react-components';
...
Available maxWidth tokens:
- `GridMaxWidthXs`: 480px
- `GridMaxWidthSm`: 576px
- `GridMaxWidthMd`: 768px
- `GridMaxWidthLg`: 992px
- `GridMaxWidthXl`: 1200px
- `GridMaxWidth2Xl`: 1400px

> **Important**: Always wrap your Layout type Grid components with GridSizeController to ensure consistent layout widths across the application.
