export const DesignToken = {
  ...
  SurfaceGradient01Start: '--surface-gradient-01-start',
  SurfaceGradient01Stop: '--surface-gradient-01-stop',
  SurfaceGradient02Start: '--surface-gradient-02-start',
  SurfaceGradient02Stop: '--surface-gradient-02-stop',
  SurfaceGradient03Start: '--surface-gradient-03-start',
  SurfaceGradient03Stop: '--surface-gradient-03-stop',
  SurfaceGradient04Start: '--surface-gradient-04-start',
  SurfaceGradient04Stop: '--surface-gradient-04-stop',
  SurfaceGradient05Start: '--surface-gradient-05-start',
  SurfaceGradient05Stop: '--surface-gradient-05-stop',
  SurfaceGradient06Start: '--surface-gradient-06-start',
  SurfaceGradient06Stop: '--surface-gradient-06-stop',
  SurfaceGradient07Start: '--surface-gradient-07-start',
  SurfaceGradient07Stop: '--surface-gradient-07-stop',
  SurfaceGradient08Start: '--surface-gradient-08-start',
  SurfaceGradient08Stop: '--surface-gradient-08-stop',
  SurfaceGradient09Start: '--surface-gradient-09-start',
  SurfaceGradient09Stop: '--surface-gradient-09-stop',
  SurfaceGradient10Start: '--surface-gradient-10-start',
  SurfaceGradient10Stop: '--surface-gradient-10-stop',
  SurfaceGradient11Start: '--surface-gradient-11-start',
  SurfaceGradient11Stop: '--surface-gradient-11-stop',
  SurfaceGradient12Start: '--surface-gradient-12-start',
  SurfaceGradient12Stop: '--surface-gradient-12-stop',
  SurfaceGradient13Start: '--surface-gradient-13-start',
  SurfaceGradient13Stop: '--surface-gradient-13-stop',
